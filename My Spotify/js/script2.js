...
async function main() {
    ...
    document.getElementById("addalbum").addEventListener("click", ()=>{
        ...
        document.querySelector(".addhtml").style.opacity = "0"
        document.querySelector(".blur").style.z = "-1"
        document.getElementById("addalbum").style.opacity = "0"
        document.querySelector(".cardcontainer").insertAdjacentHTML("afterbegin", (`<div data-folder="" class="card">
        <div class="play">
            <img class="invert" src="img/play.svg" alt="">
        </div>
        <img src="${imgpath}" alt="">
    ...
    document.querySelector(".add").addEventListener("click", ()=>{
        check = true
        document.querySelector(".addhtml").style.opacity = "1"
        document.querySelector(".blur").style.z = "0"
        document.getElementById("addalbum").style.opacity = "1"
    })

    if(check){
        document.querySelector(".fix").addEventListener("input", ()=>{
            cardtitle = document.querySelector(".fix").value
        })
        
        document.querySelector(".dis").addEventListener("input", ()=>{
            carddiscription = document.querySelector(".dis").value
        })
        
        document.querySelector(".imgpath").addEventListener("input", ()=>{
            imgpath = document.querySelector(".imgpath").value
        })
    }
